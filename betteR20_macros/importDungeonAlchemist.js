...
// Instead of step 5 run this macro, paste the map data to the text prompt and press Save
...
// eslint-disable-line no-unused-vars
	...
	const getMap = (page, msg) => {
		...
		var mapGraphics = d20.Campaign.activePage().thegraphics.filter((it) => it.get('layer') === 'map')
		...
		var selected = d20.engine.selected();
	...
	const handleInput = (msg) => {
		...
		/*try*/ {
			...
			//log("PLAYER:");
			//log(player);
			const lastPageId = player.get("lastpage");
			//log(lastPageId);

			// load the page
			const pageId = d20.Campaign.get("playerpageid");
